...
(r/'out/summary.json').write_text(json.dumps({'allowed_complete_reading':observed['complete_reading'],'allowed_host_delivery':observed['host_delivery'],'denied_destination':'NO_MATCH','missing_resource':'STOP_REQUIRED_RESOURCE'})+'\n')
PYCODE

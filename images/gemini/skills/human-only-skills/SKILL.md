...
description: 'Name the skills only a person can invoke and when to reach for each. Triggers: "human-only skills", "which skills must I run myself".'
...
context:
  ...
  intent: {mode: none}
metadata:
  capabilities: [human_only_skill_routing]
  effects: []

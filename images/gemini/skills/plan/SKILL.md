---
name: plan
description: 'Shape the existing bead or caller intent and mint one exact snapshot without creating a second planning artifact. Triggers: "plan", "discover and plan", "shape this goal".'
practices:
- bdd-gherkin
- design-by-contract
- ddd-bounded-context

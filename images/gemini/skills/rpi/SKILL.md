---
name: rpi
description: 'Run one bounded Plan, Implement, and fresh Validate experiment, then report and stop. Triggers: "run rpi", "feed this through the loop", "execute this plan", any orchestration or worker-delegation request.'
practices:
- bdd-gherkin
- tdd
- design-by-contract

...
name: discovery
spine: true
description: 'Create dense execution packets from intent, research, one exact plan, and its Premortem verdict. Triggers: "run discovery", "shape intent as BDD", "scope a feature into an execution packet".'
practices:
- adr
- lean-startup
- mythical-man-month

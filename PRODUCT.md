...
- 171 skills — reusable context packages across Claude Code, Codex, and OpenCode
...
- Distribution/runtime reach: 171 shared skills, 171 checked-in Codex artifacts, and 32 Codex overrides. `/validate` and `/curate` are additive in this train; legacy validation and mining skills remain until their shim/retirement gates are resolved.

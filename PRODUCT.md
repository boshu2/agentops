...
- 66 skills — reusable context packages across Claude Code, Codex, Gemini/Antigravity, and OpenCode
...
- Distribution/runtime reach: 66 shared skills, 66 checked-in Codex artifacts, and 20 Codex overrides. `/validate` and `/curate` are additive in this train; legacy validation and mining skills remain until their shim/retirement gates are resolved.

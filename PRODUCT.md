...
- 166 skills — reusable context packages across Claude Code, Codex, Gemini/Antigravity, and OpenCode
...
- Distribution/runtime reach: 166 shared skills, 166 checked-in Codex artifacts, and 27 Codex overrides. `/validate` and `/curate` are additive in this train; legacy validation and mining skills remain until their shim/retirement gates are resolved.

...
func TestRunPostLoopTier1Forge_SkipsWhenKillSwitchSet(t *testing.T) {
	...
	runPostLoopTier1Forge(context.Background(), t.TempDir(), summary, overnightSettings{})
...
func TestRunPostLoopTier1Forge_QueuesWhenWorkerConfigured(t *testing.T) {
	...
	summary := &overnightSummary{}
	runPostLoopTier1Forge(context.Background(), filepath.Join(tmp, "repo"), summary, overnightSettings{})
	if len(summary.Degraded) != 0 {

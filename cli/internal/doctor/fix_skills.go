...
// (skills/domain/references/standards/migration-owner.md, rule 3): the owner cannot
...
func (f skillsStaleCommandRefsFixer) Fix(ctx *MutateContext, env *DetectEnv, _ []Finding) (FixResult, error) {
	...
	for _, file := range files {
		...
		// Migration-owner discipline (skills/domain/references/standards/migration-owner.md,

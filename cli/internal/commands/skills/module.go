...
~/.cursor/skills, and ~/.pi/agent/skills — detected by the config root existing
under $HOME (Pi's user skills dir is ~/.pi/agent/skills, detected by ~/.pi/agent);
...
~/.gemini/skills, ~/.cursor/skills, and ~/.pi/agent/skills — detected by the
config root existing under $HOME (Pi's user skills dir is ~/.pi/agent/skills,
detected by ~/.pi/agent); --dest overrides to a single dir. Idempotent and

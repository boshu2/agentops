...
func parseCitationLine(line []byte, baseDir string) (types.CitationEvent, bool) {
	...
	event := types.CitationEvent{
		...
		ArtifactAuthorID:   firstCitationString(raw, "artifact_author_id", "author_id", "artifact_author"),
		CitedByAgentID:     firstCitationString(raw, "cited_by_agent_id", "cited_by_agent", "reviewer_id", "judge_id"),
		CitedByModelFamily: firstCitationString(raw, "cited_by_model_family", "model_family", "reviewer_model_family"),

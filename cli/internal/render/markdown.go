// Package render provides output formatters for agentops sessions.
package render
...
func (mf *MarkdownFormatter) Format(w io.Writer, session *sessionstore.Session) error {
	// Build template data
...
func (mf *MarkdownFormatter) buildTemplateData(session *sessionstore.Session) *templateData {
	return &templateData{
...
func (mf *MarkdownFormatter) extractTags(session *sessionstore.Session) []string {

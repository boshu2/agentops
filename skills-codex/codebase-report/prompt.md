# Codex Execution Profile -- codebase-report

Codex runtime wrapper for `codebase-report`.

## Steps

1. Read `../../skills/codebase-report/SKILL.md` and identify the exact task path, trigger, or command family that applies.

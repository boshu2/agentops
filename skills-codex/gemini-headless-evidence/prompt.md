# Codex Execution Profile -- gemini-headless-evidence

Codex runtime wrapper for `gemini-headless-evidence`.

## Steps

1. Read `../../skills/gemini-headless-evidence/SKILL.md` and identify the exact Gemini image task path that applies.
...
5. Keep source changes in `skills/gemini-headless-evidence` and Codex wrapper changes in `skills-codex/gemini-headless-evidence`; do not edit runtime-installed copies as source of truth.

...
1. Identify the exact plan, research, diff, or packet paths Fable must review.
   Use absolute paths when possible; do not ask Fable to judge only your summary.
...
6. Gate on the result: PASS continues; WARN requires plan edits or an explicit

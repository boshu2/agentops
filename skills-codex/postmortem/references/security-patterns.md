# Security Patterns for Postmortem

Security checks to run during postmortem Phase 3.
...
```python
spawn_agent(message=f"""You are a security-expert reviewer for postmortem.

Deep security review for postmortem.

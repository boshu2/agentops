...
When retrospecting an epic, run lightweight closure checks before extracting learnings. Full audit lives in `skills/postmortem/references/closure-integrity-audit.md`; retro uses the subset below.

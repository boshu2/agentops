# Executable spec for /postmortem --scope=pr — learning from PR outcomes (BC3 Loop).
# /postmortem --scope=pr turns a merged or rejected pull request into durable lessons: it categorizes

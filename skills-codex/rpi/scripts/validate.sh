...
check "SKILL.md mentions canonical premortem phase" "grep -qiE '[/\$]premortem' '$SKILL_DIR/SKILL.md'"
check "RPI docs reject legacy executable mortem spelling" "! grep -RqiE '[/\$]pre-mortem' '$SKILL_DIR/SKILL.md' '$SKILL_DIR/references'"

# Codex Execution Profile -- codebase-audit

Codex runtime wrapper for `codebase-audit`.

## Steps

1. Read `../../skills/codebase-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.

---
name: codebase-audit
description: "Run codebase audit."
---

# codebase-audit (Codex)

Codex-native entry point for the `codebase-audit` operator skill.

The AgentOps source skill `../../skills/codebase-audit/SKILL.md` is the source of truth

...
Repeatable Opus (Claude) + Codex dual-pane ATM collaboration for bounded CEP-style build/duel work; optional tri-vendor (+AGY) per source skill.
...
- Do not broaden scope beyond the requested dual-pane (or documented tri-vendor AGY) session.

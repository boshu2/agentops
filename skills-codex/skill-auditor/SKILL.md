---
name: skill-auditor
description: 'Audit an existing SKILL.md against the unified AgentOps template (15 checks: 7 wrap heal-skill, 8 are NEW). Triggers: audit skill, skill quality review, is this skill ready.'
---

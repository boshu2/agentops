# Codex Execution Profile -- codebase-pattern-extraction

Codex runtime wrapper for `codebase-pattern-extraction`.

## Steps

1. Read `../../skills/codebase-pattern-extraction/SKILL.md` and identify the exact task path, trigger, or command family that applies.

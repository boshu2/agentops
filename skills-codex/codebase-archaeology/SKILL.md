...
description: "Run codebase archaeology."
---

# codebase-archaeology (Codex)

Codex-native entry point for the `codebase-archaeology` operator skill.

The AgentOps source skill `../../skills/codebase-archaeology/SKILL.md` is the source of truth

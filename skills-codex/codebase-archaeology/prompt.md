# Codex Execution Profile -- codebase-archaeology

Codex runtime wrapper for `codebase-archaeology`.

## Steps

1. Read `../../skills/codebase-archaeology/SKILL.md` and identify the exact task path, trigger, or command family that applies.

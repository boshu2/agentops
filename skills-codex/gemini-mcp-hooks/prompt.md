# Codex Execution Profile -- gemini-mcp-hooks

Codex runtime wrapper for `gemini-mcp-hooks`.

## Steps

1. Read `../../skills/gemini-mcp-hooks/SKILL.md` and identify the exact Gemini image task path that applies.
...
5. Keep source changes in `skills/gemini-mcp-hooks` and Codex wrapper changes in `skills-codex/gemini-mcp-hooks`; do not edit runtime-installed copies as source of truth.

# Codex Execution Profile -- gemini-skills-extensions

Codex runtime wrapper for `gemini-skills-extensions`.

## Steps

1. Read `../../skills/gemini-skills-extensions/SKILL.md` and identify the exact Gemini image task path that applies.
...
5. Keep source changes in `skills/gemini-skills-extensions` and Codex wrapper changes in `skills-codex/gemini-skills-extensions`; do not edit runtime-installed copies as source of truth.

...
name: learn
spine: true
description: 'Capture bounded observations after an immutable validation verdict and emit the fourth RPI phase receipt. Use after Validate completes, when a wave or objective needs learning evidence without changing the verdict, delivery state, or tracker.'
practices:
- lean-startup
- devops

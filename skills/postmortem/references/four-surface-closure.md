...
> The #1 postmortem gap: validating code was changed but not that all surfaces were updated.
...
During postmortem Phase 1 (council validation), each judge should check:
...
## Integration with Postmortem Phases
...
> If a surface was missed, create a learning: "Feature X shipped without [surface] update -- add to premortem checklist."

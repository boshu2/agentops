...
Canonical output shapes for `skills/postmortem/SKILL.md`. When this file and the
...
**Cycle-Time Trend:** <faster|slower|flat vs prior postmortems>
...
When a postmortem closes an item on validation or policy evidence without a
...
bash skills/postmortem/scripts/write-evidence-only-closure.sh \
  ...
  --artifact ".agents/council/2026-03-09-postmortem-na-a7e.md"
```

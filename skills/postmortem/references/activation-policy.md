...
The compiler reads the learning, extracts the enforceable rule, and writes a constraint file to `.agents/constraints/`. The resulting constraint is available to future premortem and vibe sessions.

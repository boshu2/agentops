---
name: validate
description: 'Freshly judge one frozen intent and exact subject, persist verdict.v3, and stop. Triggers: "validate", "independently validate", "vibe".'
practices:
- design-by-contract
- llm-eval-harness
...
metadata:
  ...
  disposition: keep
output_contract: schemas/verdict.v3.schema.json
---

...
metadata:
  ...
  effects: [read_intent_and_repository, read_declared_external_ground_truth, execute_authorized_bounded_control, use_disposable_control_state, update_intent_source, write_intent_snapshot]

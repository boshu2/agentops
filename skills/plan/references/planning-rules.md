...
**Evidence:** Consumer succeeds with horizontal separation (SOUL/AGENTS/IDENTITY own contracts completely). ArgoCD sync waves enforce ordering without external tooling. Prior attempts at adding a third layer with fuzzy boundaries produced unclear ownership and bugs at every seam.

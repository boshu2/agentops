---
name: goal-design
description: 'Create deterministic goal-design packets. Triggers: "goal prompt", "goal-design packet", "turn this goal into loop-ready work".'
practices:
- bdd-gherkin
- design-by-contract
- tdd
...
metadata:
  ...
  dependencies:
  - discovery
output_contract: 'packet: .agents/goal-design/<slug> checked by scripts/check-goal-design-packet.sh'
---

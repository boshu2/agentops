...
- This skill is purely session-boundary (path-scope freezing within a session). Cron-cadence orchestration lives outside AgentOps in NTM background sessions coordinated through mcp-agent-mail, not in an AgentOps-shipped daemon.

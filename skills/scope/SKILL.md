...
- This skill is purely session-boundary (path-scope freezing within a session). Cron-cadence orchestration lives outside AgentOps on the orchestration substrate (the reference orchestration substrate), not in an AgentOps-shipped daemon.

...
description: 'Scaffold a new Claude Workflow script (.claude/workflows/*.js) — deterministic multi-agent orchestration — from the operating-loop.js template and the Workflow primitives. Triggers: "build a workflow", "create a workflow", "scaffold workflow", "new workflow", "author a workflow".'
practices:

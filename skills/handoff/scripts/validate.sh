...
check "feature reference is linked" "grep -Fq '[references/handoff.feature](references/handoff.feature)' '$SKILL_DIR/SKILL.md' && test -s '$SKILL_DIR/references/handoff.feature'"

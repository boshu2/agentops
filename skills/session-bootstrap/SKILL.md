...
- **Pipeline submit** — the orchestration substrate (the reference orchestration substrate) and headless CI agents call `ao session bootstrap --json` before claiming work.

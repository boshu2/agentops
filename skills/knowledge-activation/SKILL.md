...
- packet refresh builders under `.agents/scripts/` only when `ao knowledge activate` must rebuild source manifests, topics, promoted packets, and chunk bundles from scratch

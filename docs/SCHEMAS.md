...
| [`routing-policy.v1.schema.json`](https://github.com/boshu2/agentops/blob/main/schemas/routing-policy.v1.schema.json) | Agentopsd routing policy for model/provider/runtime lanes, authority levels, concurrency caps, and manual-merge defaults. See [`Routing Policy`](contracts/routing-policy.md). |

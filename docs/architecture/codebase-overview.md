...
| **Detail owners** | [`agent-workflow-reference.md`](../agent-workflow-reference.md), [`CI-CD.md`](../CI-CD.md), [`codex-skill-api.md`](../contracts/codex-skill-api.md), [`repo-execution-profile.md`](../contracts/repo-execution-profile.md) |

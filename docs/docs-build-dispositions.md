...
| Scripts | `../../scripts/*.sh` (`pawl.sh`, `pawl-review.sh`, `pawl-verdict.sh`, `reconcile-pr.sh`, `evolve/halt-check.sh`) | `contracts/pawls.md`, `doctrine/operating-discipline.md` | Executable source; not site content. |

...
|-----------|--------|------|
| `/pre-mortem` | [skills/pre-mortem/SKILL.md](../skills/premortem/SKILL.md) | Loads plan-review validation before code exists |
| `/validate` | [skills/validate/SKILL.md](../skills/validate/SKILL.md) | Runs post-implementation validation instead of stopping at build/test (absorbs the retired `/vibe`) |

...
```json
{
  ...
  "tracker_commands": {
    ...
    "close": "br close <id> --reason \"Completed\" --json"
  },
  "work_selection_order": [
    "harvested",
    "beads",
...
**Validate before proposing.** Before suggesting a new capability or safeguard, verify it doesn't already exist: check the `ao` command surface (`cli/cmd/ao/`, generated `cli/docs/COMMANDS.md`), `.github/workflows/validate.yml`, `GOALS.md`, and existing SKILL.md files.

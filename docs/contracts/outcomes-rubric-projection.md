...
`ao eval outcomes compile`. Schema: `schemas/outcomes-rubric.v1.schema.json`.
...
- **Standalone validator:** `scripts/validate-outcomes-rubric.sh`
...
- **Acceptance fixtures:** `tests/fixtures/outcomes-rubric/` —
  ...
  `tests/scripts/validate-outcomes-rubric.bats`.

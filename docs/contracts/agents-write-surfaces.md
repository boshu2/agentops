...
| `operator` | persistent | cli | operator-intents | Durable operator intent records (halt, rescope, handoff) appended to `.agents/operator/intents.jsonl` via the typed BC4 OperatorPort |

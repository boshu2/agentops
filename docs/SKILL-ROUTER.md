...
| [postmortem](../skills/postmortem/SKILL.md) | Analyze a known outcome. Use when: a postmortem or interim analysis is explicitly requested; name the evidence cutoff. Consumes judgment, does not gate code acceptance or require a lesson. |

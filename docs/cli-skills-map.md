...
Auto-audited 2026-04-24; targeted runtime-proof update 2026-04-28. 84 generated CLI command headings, 69 source skills. (AgentOps 3.0 is hookless — there is no runtime hook surface; lifecycle work is driven by skills + the `ao` CLI, with CI as the authoritative gate.)

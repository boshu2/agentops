...
AgentOps 4.0 makes native coding the default. Give your coding agent accepted
...
Separate opt-in read guards block oversized unbounded reads. This major release
...
- Changed: Native onboarding leads with the agent and shell; managed full plugins and selected source links remain optional distribution paths. Release version defaults are aligned at 4.0.0.
...
- Changed: The release summary covers the full v3.6.0-to-v4.0.0 interval, including CLI removals, recovery, evidence helpers, skill consolidation and runtime changes.
...
- Claude writer validation previously observed repeated execution of the supplied check and one fenced JSON receipt. Those failures remain open at this draft's cutoff; deterministic workflow checks alone do not establish the live fix.
...
[Full changelog](https://github.com/boshu2/agentops/compare/v3.6.0...v4.0.0)

...
- Added: docs/3.2.md (historical reference; retired path: `../3.2.md`), the release narrative, plus a quick-start that lands a first verdict in one command.

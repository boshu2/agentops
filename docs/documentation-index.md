...
- [AgentOps Skill Domain Map](reference/agentops-skill-domain-map.md) — All 58 checked-in skills mapped to Corpus, Validation, Loop, Factory, and Runtime domains (drift-checked by `scripts/check-registry-drift.sh`)

...
- Using `/research` to explore a codebase
- Using `/implement` to make changes
- Basic git workflow with Claude Code
...
| Command | Purpose |
|---------|---------|
| `/research <topic>` | Explore codebase, understand patterns |

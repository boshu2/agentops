...
| [validate](../skills/validate/SKILL.md) | Freshly judge a finished change against original acceptance. Use when: an acceptance verdict or independent proof is requested. Clarify generic checking or readiness intent first. |

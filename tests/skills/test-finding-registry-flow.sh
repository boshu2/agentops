...
check_contains "$PM_SKILL" '.agents/pre-mortem-checks' "/premortem reads compiled checks first"
...
check_contains "$POST_MORTEM_SKILL" '.agents/pre-mortem-checks' "/postmortem reads compiled prevention inputs"

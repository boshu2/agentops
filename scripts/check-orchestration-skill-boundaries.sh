...
active=(skills/ntm/SKILL.md skills/agent-mail/SKILL.md skills/agent-native/SKILL.md skills/orchestrate/SKILL.md skills/implement/SKILL.md skills/using-gc/SKILL.md)

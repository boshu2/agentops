...
active=(skills/ntm/SKILL.md skills/agent-mail/SKILL.md skills/agent-native/SKILL.md skills/automation-shape-routing/SKILL.md skills/swarm/SKILL.md skills/crank/SKILL.md skills/using-gc/SKILL.md)

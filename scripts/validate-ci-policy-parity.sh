...
#
# soc-3oij: the canonical CI table is generated. This script is a thin wrapper
...
if "$GENERATOR" --check; then
    ...
    echo "Action: run scripts/generate-ci-jobs-table.sh --write to refresh ${AGENTS_LABEL}," >&2

...
VALID_SOURCES=(council-finding retro-learning retro-pattern evolve-generator feature-suggestion backlog-processing postmortem-finding post-mortem-finding manifest-classification dream-degraded)

...
- **bd Server-Mode Closeout Needs Contract Proof**: Server-mode bd sessions
  should verify active database, project id, and push-mode semantics before
  treating local tracker writes as fully landed (source:
  `.agents/learnings/2026-05-01-bd-server-mode-closeout-contract.md`)
